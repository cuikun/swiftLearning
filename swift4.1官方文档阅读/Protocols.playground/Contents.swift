...
protocol DiceGameDelegate: AnyObject {
    ...
    func game(_ game: DiceGame, didStartNewTurnWith diceRoll: Int)
...
class SnakesAndLadders: DiceGame {
    ...
    func play() {
        ...
        gameLoop: while square != finalSquare {
            ...
            delegate?.game(self, didStartNewTurnWith: diceRoll)
...
let setattle = City(name: "Seattle", latitude: 47.6, longitude: -122.3)
beginConcert(in: setattle)
